  ...
  return (
    <header className="bg-[rgba(255,251,234,1)] flex flex-col overflow-hidden items-stretch">
      <div className="flex flex-col relative min-h-screen w-full items-center pt-6 pb-[20px] px-20 max-md:max-w-full max-md:pb-[15px] max-md:px-5 max-sm:px-3 max-sm:pb-[10px] max-sm:min-h-screen">
        ...
        <div className="max-sm:block hidden max-sm:flex max-sm:flex-col max-sm:items-center">
          ...
          <div className="max-sm:mb-4">
            <button className="box-border gap-2 border text-black text-sm font-medium cursor-pointer bg-[#FFD51A] px-10 py-[15px] rounded-[500px] border-solid border-[#483B00] hover:bg-[#FFD000] transition-colors">
              Register to Attend
            </button>
          </div>
          
          {/* Badges on Small Screens */}
          <div className="max-sm:flex max-sm:gap-2 max-sm:justify-center">
          </div>
        </div>

        {/* Large Screen Layout - Original Order */}
        <div className="relative w-[600px] max-w-full ml-[31px] mt-[100px] max-md:mt-[90px] max-sm:hidden max-sm:ml-0 max-sm:px-4">
          <div className="gap-4 flex max-md:flex-col max-md:items-stretch">
            <div className="w-[33%] max-md:w-full max-md:ml-0">
              <div className="rotate-[0.2617993898945194rad] bg-[rgba(199,164,5,1)] relative flex items-center gap-2 text-xs text-white font-extrabold whitespace-nowrap tracking-[2.2px] leading-5 w-full justify-center mt-[8px] px-[20px] py-[4px] rounded-[500px] border-[rgba(255,242,184,1)] border-solid border-[8px] max-md:mt-4 max-md:px-4">
            ...
            <div className="w-[33%] ml-4 max-md:w-full max-md:ml-0">
              <img
                src="https://api.builder.io/api/v1/image/assets/e30a9ed2d282417f852404d6b0366525/9d140c56cb33016a2fc17547b33b0480be56f453?placeholderIfAbsent=true"
                className="aspect-[0.57] object-contain w-[80px] shrink-0 max-w-full grow max-md:mt-4"
                alt="EthNile Logo"
              />
            </div>
            <div className="w-[33%] ml-4 max-md:w-full max-md:ml-0">
              <div className="rotate-[-0.2617993898945194rad] bg-[rgba(184,152,9,1)] relative flex items-center gap-2 text-xs text-white font-extrabold whitespace-nowrap tracking-[2.2px] leading-5 w-full justify-center mt-2 px-[20px] py-[4px] rounded-[500px] border-[rgba(255,242,184,1)] border-solid border-[8px] max-md:px-4">
        ...
        {/* ETHNile Logo - Only on Large Screens */}
        <div className="relative z-10 mt-[15px] mb-[10px] max-md:hidden max-sm:hidden">
          <div
        ...
        <div className="relative z-20 flex justify-center mt-[10px] max-md:mt-[12px] max-sm:hidden">
        ...
        <div className="relative mb-[-30px] w-full max-w-[800px] ml-6 mt-[10px] max-md:max-w-full max-md:mb-[-10px] max-md:mt-[15px] max-sm:hidden max-sm:ml-0 max-sm:px-4 max-sm:mb-[-15px]">
          <div className="gap-4 flex max-md:flex-col max-md:items-stretch">
            <div className="w-[77%] max-md:w-full max-md:ml-0">
              <div className="relative flex w-full flex-col items-stretch max-md:max-w-full">
                <div className="w-full max-md:max-w-full">
                  <div className="gap-4 flex max-md:flex-col max-md:items-stretch">
                    <div className="w-[27%] max-md:w-full max-md:ml-0">
                      <div className="rotate-[-0.2617993898945194rad] bg-[rgba(255,224,88,1)] flex grow items-center gap-2 text-xs text-black font-extrabold whitespace-nowrap tracking-[2.2px] leading-5 w-full justify-center px-[20px] py-[10px] rounded-[500px] border-[rgba(255,240,174,1)] border-solid border-[15px] max-md:mt-8 max-md:px-4">
                    ...
                    <div className="w-[73%] ml-4 max-md:w-full max-md:ml-0">
                      <img
                        ...
                        className="aspect-[8.85] object-contain w-[320px] mt-2 max-md:w-[280px] max-md:mt-8"
                        alt="Event details"
                      />
                    </div>
                  </div>
                ...
                <div className="rotate-[0.2617993898945194rad] bg-[rgba(254,239,171,1)] flex items-center gap-2 text-xs text-black font-extrabold tracking-[2.2px] leading-5 justify-center ml-auto mr-24 mt-4 px-[20px] py-[10px] rounded-[500px] border-[rgba(255,233,135,1)] border-solid border-[15px] max-md:mx-auto max-md:px-4">
            ...
            <div className="w-[23%] ml-4 max-md:w-full max-md:ml-0">
              <div className="rotate-[-0.2617993898945194rad] bg-[rgba(255,234,139,1)] relative flex items-center gap-2 text-xs text-black font-extrabold uppercase tracking-[2.2px] leading-5 w-full justify-center mt-[26px] px-[20px] py-[10px] rounded-[500px] border-[rgba(255,240,169,1)] border-solid border-[15px] max-md:mt-7 max-md:px-4">
        ...
        <div className="hidden max-sm:block max-sm:mt-8 max-sm:mb-8">
