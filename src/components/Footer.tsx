...
const Footer: React.FC = () => {
  return (
    <footer className="w-full relative bg-[#141100] mt-[100px]">
      ...
      <div className="relative z-10 max-w-[1165px] mx-auto px-6 flex flex-col justify-between py-4">
        {/* Top Section */}
        <div className="flex items-center justify-between pt-2">
          ...
          />
          <div className="flex items-center gap-[75px] max-md:gap-10 max-sm:gap-[30px]">
            <nav className="flex flex-col items-start gap-3 opacity-70">
  ...
  <div className="flex justify-between items-center px-6 py-4 mb-8">
          <nav className="flex items-center gap-8 max-md:flex-col max-md:gap-[15px]">
          ...
          <div className="flex items-center gap-4 max-sm:gap-1.5">
            <button className="w-10 h-10 bg-[#FFE677] rounded-full flex items-center justify-center hover:bg-[#FFE055] transition-colors">
