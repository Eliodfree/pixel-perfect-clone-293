    ...
    <header className="bg-[rgba(255,251,234,1)] flex flex-col overflow-hidden items-stretch">
      <div className="flex flex-col relative min-h-screen w-full items-center pt-6 pb-[20px] px-20 max-md:max-w-full max-md:pb-[15px] max-md:px-5 max-sm:px-3 max-sm:pb-[10px] max-sm:min-h-screen">
        ...
        <img
          ...
          className="absolute h-full w-full object-cover inset-0 max-sm:hidden"
          alt="Background"
        />
        {/* Background Image for Small Screens */}
        <img
          src="/smallsizeback.png"
          className="absolute h-full w-full object-cover inset-0 hidden max-sm:block"
          alt="Mobile Background"
        />
        
        {/* Navigation */}
         <nav className="box-border absolute z-10 m-0 p-0 top-6 inset-x-[90px] max-md:inset-x-5 max-sm:inset-x-2.5 max-sm:top-3">
        <div className="box-border flex w-full h-[65px] justify-between items-center backdrop-blur-[5px] bg-[rgba(255,247,213,0.50)] m-0 px-[25px] py-2 rounded-[500px] border-2 border-solid border-[#FEEC96] max-md:h-auto max-md:px-4 max-md:py-2 max-sm:flex-col max-sm:gap-2 max-sm:h-auto max-sm:px-3 max-sm:py-2 max-sm:rounded-[20px]">
          <div className="box-border flex items-center gap-[30px] m-0 p-0 max-sm:gap-[15px] max-sm:w-full max-sm:justify-center">
        ...
        {/* Hero Content */}
        <div className="relative w-[600px] max-w-full ml-[31px] mt-[100px] max-md:mt-[90px] max-sm:mt-[100px] max-sm:ml-0 max-sm:px-4">
          <div className="gap-4 flex max-md:flex-col max-md:items-stretch max-sm:gap-2">
            <div className="w-[33%] max-md:w-full max-md:ml-0">
              <div className="rotate-[0.2617993898945194rad] bg-[rgba(199,164,5,1)] relative flex items-center gap-2 text-xs text-white font-extrabold whitespace-nowrap tracking-[2.2px] leading-5 w-full justify-center mt-[8px] px-[20px] py-[4px] rounded-[500px] border-[rgba(255,242,184,1)] border-solid border-[8px] max-md:mt-4 max-md:px-4 max-sm:mt-2 max-sm:px-3 max-sm:py-2 max-sm:text-[10px] max-sm:tracking-[1.8px] max-sm:border-[6px]">
                <span className="self-stretch my-auto">CONFERENCE</span>
              </div>
            </div>
            <div className="w-[33%] ml-4 max-md:w-full max-md:ml-0">
              <img
                ...
                className="aspect-[0.57] object-contain w-[80px] shrink-0 max-w-full grow max-md:mt-4 max-sm:w-[70px] max-sm:mt-2"
                alt="EthNile Logo"
              />
            </div>
            <div className="w-[33%] ml-4 max-md:w-full max-md:ml-0">
              <div className="rotate-[-0.2617993898945194rad] bg-[rgba(184,152,9,1)] relative flex items-center gap-2 text-xs text-white font-extrabold whitespace-nowrap tracking-[2.2px] leading-5 w-full justify-center mt-2 px-[20px] py-[4px] rounded-[500px] border-[rgba(255,242,184,1)] border-solid border-[8px] max-md:px-4 max-sm:mt-2 max-sm:px-3 max-sm:py-2 max-sm:text-[10px] max-sm:tracking-[1.8px] max-sm:border-[6px]">
        ...
        <div className="relative mb-[-30px] w-full max-w-[800px] ml-6 mt-[10px] max-md:max-w-full max-md:mb-[-10px] max-md:mt-[15px] max-sm:mt-[12px] max-sm:ml-0 max-sm:px-4 max-sm:mb-[-15px]">
          <div className="gap-4 flex max-md:flex-col max-md:items-stretch max-sm:gap-2">
            <div className="w-[77%] max-md:w-full max-md:ml-0">
              <div className="relative flex w-full flex-col items-stretch max-md:max-w-full">
                <div className="w-full max-md:max-w-full">
                  <div className="gap-4 flex max-md:flex-col max-md:items-stretch max-sm:gap-2">
                    <div className="w-[27%] max-md:w-full max-md:ml-0">
                      <div className="rotate-[-0.2617993898945194rad] bg-[rgba(255,224,88,1)] flex grow items-center gap-2 text-xs text-black font-extrabold whitespace-nowrap tracking-[2.2px] leading-5 w-full justify-center px-[20px] py-[10px] rounded-[500px] border-[rgba(255,240,174,1)] border-solid border-[15px] max-md:mt-8 max-md:px-4 max-sm:mt-4 max-sm:px-3 max-sm:py-2 max-sm:text-[10px] max-sm:tracking-[1.8px] max-sm:border-[12px]">
                        <span className="self-stretch my-auto">HYBRID</span>
                      </div>
                    </div>
                    <div className="w-[73%] ml-4 max-md:w-full max-md:ml-0">
                      <img
                        src="https://api.builder.io/api/v1/image/assets/e30a9ed2d282417f852404d6b0366525/3adbcd422562c917c71dd488df96c34131c8ab35?placeholderIfAbsent=true"
                        className="aspect-[8.85] object-contain w-[320px] mt-2 max-md:w-[280px] max-md:mt-8 max-sm:mt-4 max-sm:w-[240px]"
                        alt="Event details"
                      />
                    </div>
                  </div>
                ...
                <div className="rotate-[0.2617993898945194rad] bg-[rgba(254,239,171,1)] flex items-center gap-2 text-xs text-black font-extrabold tracking-[2.2px] leading-5 justify-center ml-auto mr-24 mt-4 px-[20px] py-[10px] rounded-[500px] border-[rgba(255,233,135,1)] border-solid border-[15px] max-md:mx-auto max-md:px-4 max-sm:mt-2 max-sm:px-3 max-sm:py-2 max-sm:text-[10px] max-sm:tracking-[1.8px] max-sm:border-[12px] max-sm:mr-0">
                  <span className="self-stretch my-auto">16TH - 19TH OCT.</span>
                </div>

              </div>
            </div>

            <div className="w-[23%] ml-4 max-md:w-full max-md:ml-0">
              <div className="rotate-[-0.2617993898945194rad] bg-[rgba(255,234,139,1)] relative flex items-center gap-2 text-xs text-black font-extrabold uppercase tracking-[2.2px] leading-5 w-full justify-center mt-[26px] px-[20px] py-[10px] rounded-[500px] border-[rgba(255,240,169,1)] border-solid border-[15px] max-md:mt-7 max-md:px-4 max-sm:mt-4 max-sm:px-3 max-sm:py-2 max-sm:text-[10px] max-sm:tracking-[1.8px] max-sm:border-[12px]">
                <span className="self-stretch my-auto">Kampala, Uganda</span>
              </div>
            </div>
