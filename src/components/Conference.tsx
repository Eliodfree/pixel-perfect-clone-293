...
const Conference: React.FC = () => {
  ...
  return (
    <section className="box-border flex flex-col items-start gap-9 w-full m-0 p-0">
      <article className="box-border flex flex-col items-start gap-[60px] w-full border bg-[#FFEEA1] m-0 p-[60px] rounded-[20px] border-solid border-black max-md:gap-10 max-md:px-[30px] max-md:py-10 max-sm:gap-[30px] max-sm:px-5 max-sm:py-[30px]">
