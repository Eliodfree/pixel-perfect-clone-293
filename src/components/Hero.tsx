...
const Hero = () => {
  return (
    <header className="bg-[rgba(255,251,234,1)] flex flex-col overflow-hidden items-stretch">
      <div className="flex flex-col relative min-h-[1013px] w-full items-center pt-9 pb-[136px] px-20 max-md:max-w-full max-md:pb-[100px] max-md:px-5">
        <img
        ...
        <div className="box-border flex w-full h-[77px] justify-between items-center backdrop-blur-[5px] bg-[rgba(255,247,213,0.50)] m-0 px-[30px] py-3 rounded-[500px] border-2 border-solid border-[#FEEC96] max-md:h-auto max-md:px-5 max-md:py-2 max-sm:flex-col max-sm:gap-2.5 max-sm:h-auto max-sm:px-[15px] max-sm:py-1.5">
          <div className="box-border flex items-center gap-[30px] m-0 p-0 max-sm:gap-[15px]">
            ...
            <div className="box-border flex items-center gap-0.5 m-0 p-0 max-md:hidden">
              <button className="box-border gap-2.5 text-[#141100] text-sm font-semibold leading-6 cursor-pointer m-0 px-5 py-3 rounded-sm hover:bg-[rgba(255,255,255,0.1)] transition-colors">
                About Event
              </button>
              <button className="box-border gap-2.5 text-[#141100] text-sm font-semibold leading-6 cursor-pointer m-0 px-5 py-3 rounded-sm hover:bg-[rgba(255,255,255,0.1)] transition-colors">
                Schedule
          ...
          <div className="box-border flex items-center gap-4 m-0 p-0 max-sm:gap-2.5">
            <button className="box-border gap-2.5 text-neutral-800 text-sm font-semibold leading-6 cursor-pointer bg-[#FFE677] m-0 px-5 py-3 rounded-[500px] max-md:text-xs max-md:px-4 max-md:py-2 max-sm:text-[11px] max-sm:px-3 max-sm:py-1.5 hover:bg-[#FFE055] transition-colors">
              Become a Sponsor
            </button>
            <button className="box-border gap-2.5 text-neutral-800 text-sm font-semibold leading-6 cursor-pointer w-[167px] bg-[#F9CC00] m-0 px-5 py-3 rounded-[200px] max-md:text-xs max-md:w-auto max-md:px-4 max-md:py-2 max-sm:text-[11px] max-sm:px-3 max-sm:py-1.5 hover:bg-[#E6B800] transition-colors">
              Apply to Speak
            </button>
          </div>
        </div>
        ...
        {/* Hero Content */}
        <div className="relative w-[800px] max-w-full ml-[31px] mt-[95px] max-md:mt-10">
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
            <div className="w-[33%] max-md:w-full max-md:ml-0">
              <div className="rotate-[0.2617993898945194rad] bg-[rgba(199,164,5,1)] relative flex items-center gap-2.5 text-sm text-white font-extrabold whitespace-nowrap tracking-[2.8px] leading-6 w-full justify-center mt-[43px] px-[30px] py-[15px] rounded-[500px] border-[rgba(255,242,184,1)] border-solid border-[20px] max-md:mt-10 max-md:px-5">
            ...
            <div className="w-[33%] ml-5 max-md:w-full max-md:ml-0">
              <img
                ...
                className="aspect-[0.57] object-contain w-[153px] shrink-0 max-w-full grow max-md:mt-10"
                alt="EthNile Logo"
              />
            </div>
            <div className="w-[33%] ml-5 max-md:w-full max-md:ml-0">
              <div className="rotate-[-0.2617993898945194rad] bg-[rgba(184,152,9,1)] relative flex items-center gap-2.5 text-sm text-white font-extrabold whitespace-nowrap tracking-[2.8px] leading-6 w-full justify-center mt-10 px-[30px] py-[15px] rounded-[500px] border-[rgba(255,242,184,1)] border-solid border-[20px] max-md:px-5">
      ...
      <div>
        ...
        <div className="relative mb-[-27px] w-full max-w-[1054px] ml-6 mt-[175px] max-md:max-w-full max-md:mb-2.5 max-md:mt-[180px]">
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
            <div className="w-[77%] max-md:w-full max-md:ml-0">
              <div className="relative flex w-full flex-col items-stretch max-md:max-w-full">
                <div className="w-full max-md:max-w-full">
                  <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
                    <div className="w-[27%] max-md:w-full max-md:ml-0">
                      <div className="rotate-[-0.2617993898945194rad] bg-[rgba(255,224,88,1)] flex grow items-center gap-2.5 text-sm text-black font-extrabold whitespace-nowrap tracking-[2.8px] leading-6 w-full justify-center px-[30px] py-[15px] rounded-[500px] border-[rgba(255,240,174,1)] border-solid border-[20px] max-md:mt-10 max-md:px-5">
                    ...
                    <div className="w-[73%] ml-5 max-md:w-full max-md:ml-0">
                      <img
                        ...
                        className="aspect-[8.85] object-contain w-[533px] mt-3 max-md:max-w-full max-md:mt-10"
                        alt="Event details"
                      />
                    </div>
                  </div>
                ...
                <div className="rotate-[0.2617993898945194rad] bg-[rgba(254,239,171,1)] flex items-center gap-2.5 text-sm text-black font-extrabold tracking-[2.8px] leading-6 justify-center ml-auto mr-32 mt-6 px-[30px] py-[15px] rounded-[500px] border-[rgba(255,233,135,1)] border-solid border-[20px] max-md:mx-auto max-md:px-5">
            ...
            <div className="w-[23%] ml-5 max-md:w-full max-md:ml-0">
              <div className="rotate-[-0.2617993898945194rad] bg-[rgba(255,234,139,1)] relative flex items-center gap-2.5 text-sm text-black font-extrabold uppercase tracking-[2.8px] leading-6 w-full justify-center mt-[34px] px-[30px] py-[15px] rounded-[500px] border-[rgba(255,240,169,1)] border-solid border-[20px] max-md:mt-9 max-md:px-5">
