  ...
  return (
    <header className="bg-[rgba(255,251,234,1)] flex flex-col overflow-hidden items-stretch">
      <div className="flex flex-col relative min-h-screen w-full items-center pt-6 pb-[20px] px-20 max-md:max-w-full max-md:pb-[15px] max-md:px-5 max-sm:px-3 max-sm:pb-[10px] max-sm:min-h-screen">
        ...
        <div className={`relative w-[600px] max-w-full ml-[31px] mt-[100px] max-md:mt-[90px] max-sm:hidden max-sm:ml-0 max-sm:px-4 ${isMobileMenuOpen ? 'max-sm:blur-sm' : ''}`}>
        ...
        <div className={`relative z-10 mt-[15px] mb-[10px] max-md:hidden max-sm:hidden ${isMobileMenuOpen ? 'max-sm:blur-sm' : ''}`}>
          <div
            dangerouslySetInnerHTML={{
              __html:
        ...
        <div className={`relative mb-[-30px] w-full max-w-[800px] ml-6 mt-[10px] max-md:max-w-full max-md:mb-[-10px] max-md:mt-[15px] max-sm:hidden max-sm:ml-0 max-sm:px-4 max-sm:mb-[-15px] ${isMobileMenuOpen ? 'max-sm:blur-sm' : ''}`}>
          <div className="gap-4 flex max-md:flex-col max-md:items-stretch">
