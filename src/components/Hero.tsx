  ...
  return (
    <header className="bg-[rgba(255,251,234,1)] flex flex-col overflow-hidden items-stretch">
      <div className="flex flex-col relative min-h-[1013px] w-full items-center pt-9 pb-[136px] px-20 max-md:max-w-full max-md:pb-[100px] max-md:px-5">
        ...
        {/* Hero Content */}
        <div className="relative w-[800px] max-w-full ml-[31px] mt-[75px] max-md:mt-10">
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
            <div className="w-[77%] max-md:w-full max-md:ml-0">
              <div className="relative flex w-full flex-col items-stretch max-md:max-w-full">
                ...
                <div className="rotate-[0.2617993898945194rad] bg-[rgba(254,239,171,1)] flex items-center gap-2.5 text-sm text-black font-extrabold tracking-[2.8px] leading-6 justify-center mr-[167px] mt-6 px-[30px] py-[15px] rounded-[500px] border-[rgba(255,233,135,1)] border-solid border-[20px] max-md:mr-2.5 max-md:px-5">
